...
import { CheckCircle2, LayoutGrid, XCircle, User, Info, Bookmark, MapPin, Tag } from 'lucide-react';
        ...
        >
            <div className="p-6">
                <div className="mb-6 flex items-center justify-between border-b border-zinc-100 pb-4 dark:border-zinc-800">
                    <div>
                        <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-50">출결 현황 상세</h3>
                        <p className="text-xs text-zinc-500 dark:text-zinc-400 font-medium">Click a session to see details</p>
                    </div>
                </div>
                            ...
                            className={cn(
                                ...
                                detail.status === '출석'
                                    ...
                                    : detail.status === '결석'
                                      ...
                                      : 'border-zinc-100 bg-zinc-100/50 text-zinc-400 dark:border-zinc-800 dark:bg-zinc-900',
                            )}
                        >
                        ...
                        <div className="overflow-hidden rounded-2xl border border-zinc-100 bg-zinc-50/50 p-5 dark:border-zinc-800 dark:bg-zinc-900/30">
                            <div className="mb-4 flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-white text-xs font-black shadow-sm dark:bg-zinc-800 dark:text-zinc-400">
                                        #{selectedIndex! + 1}
                                    </span>
                                    <h4 className="text-sm font-bold text-zinc-900 dark:text-zinc-50">{selectedDetail.date}</h4>
                                </div>
                                <span className={cn(
                            ...
                            <div className="space-y-4">
                                {selectedDetail.title && (
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">주제 / 제목</span>
                                            <span className="text-sm font-bold text-zinc-800 dark:text-zinc-200 leading-snug">{selectedDetail.title}</span>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex items-start gap-3">
                                        <User className="mt-0.5 h-4 w-4 text-zinc-400 shrink-0" />
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">강사</span>
                                            <span className="text-sm font-medium text-zinc-700 dark:text-zinc-300">{selectedDetail.lecturer || '-'}</span>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        <Tag className="mt-0.5 h-4 w-4 text-zinc-400 shrink-0" />
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">구분</span>
                                            <span className="text-sm font-medium text-zinc-700 dark:text-zinc-300">{selectedDetail.type || '-'}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">소속</span>
                                            <span className="text-sm font-medium text-zinc-700 dark:text-zinc-300 truncate">{selectedDetail.department || '-'}</span>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        <CheckCircle2 className="mt-0.5 h-4 w-4 text-zinc-400 shrink-0" />
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">평가</span>
                                            <span className="text-sm font-medium text-zinc-700 dark:text-zinc-300">{selectedDetail.evaluation || '-'}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {selectedDetail.remarks && (
                                    <div className="flex items-start gap-3 border-t border-zinc-200/50 pt-4 dark:border-zinc-800/50">
                                        ...
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">비고</span>
                                            <span className="text-sm italic text-zinc-600 dark:text-zinc-400 leading-snug">{selectedDetail.remarks}</span>
                                        </div>
                                    </div>
                                )}
                            </div>
                ...
                <div className="mt-8 grid grid-cols-3 gap-4 border-t border-zinc-100 pt-6 dark:border-zinc-800">
                    <div className="text-center">
                        <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider mb-1">총 강의</p>
                    ...
                    <div className="text-center border-x border-zinc-100 dark:border-zinc-800">
                        ...
                        <p className="text-base font-black text-emerald-600 dark:text-emerald-400">{attendedAttendance}</p>
                    </div>
                    <div className="text-center">
